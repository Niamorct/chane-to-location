        ...
        {mob?(
          <div style={{display:"flex",flexDirection:"column",gap:8,marginBottom:10}}>
            <div style={{display:"flex",alignItems:"center",gap:6}}>
              <button onClick={()=>setSelDate(ad(selDate,-1))} style={{background:S2,border:"none",color:"#E2E8F0",width:40,height:40,borderRadius:8,cursor:"pointer",fontSize:22,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>‹</button>
            ...
            <div style={{display:"flex",gap:6}}>
              ...
              <button onClick={openNewR} style={{flex:1,background:"linear-gradient(135deg,#10B981,#3B82F6)",border:"none",color:"#fff",padding:"10px 14px",borderRadius:8,cursor:"pointer",fontSize:13,fontWeight:700}}>＋ Nouvelle réservation</button>
            </div>
          </div>
        ):(
